...
import { Users, Brain, BookOpen, Clock, Target } from "lucide-react";
import {
  AreaChart,
  Area,
  XAxis,
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          >
            <div
              className={`w-12 h-12 rounded-lg bg-${stat.color}-500/20 flex items-center justify-center mb-4`}
            >
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <span className={`text-${stat.color}-400 text-sm`}>
                {stat.change}
              </span>
            </div>
          </motion.div>
